...
namespace MiniShop.Business.Abstract
{
    public interface ICategoryService
    {
        ...
        Task<Response<List<CategoryDTO>>> GetIsDeletedCategoriesAsync(bool IsDeleted = false);
        //Admin panelde kullanılacak, active-pasive kayıtları getirecek metot
        Task<Response<List<CategoryDTO>>> GetIsActiveCategoriesAsync(bool IsActive=true);
