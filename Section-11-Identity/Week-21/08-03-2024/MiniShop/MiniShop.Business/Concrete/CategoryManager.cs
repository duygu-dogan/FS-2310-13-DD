...
namespace MiniShop.Business.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<Response<CategoryViewModel>> GetByUrlAsync(string categoryUrl)
        {
            var category = await _repository.GetByIdAsync(c => c.Url == categoryUrl, source => source
               .Include(x => x.ProductCategories)
               .ThenInclude(y => y.Product));
            if (category == null)
            {
