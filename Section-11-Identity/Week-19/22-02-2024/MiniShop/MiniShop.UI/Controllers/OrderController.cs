    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Checkout()
        {
            ...
            OrderViewModel orderViewModel = new OrderViewModel
            {
                ...
                CardNumber= "5311570000000005", CardName = "Sezen Aksu", ExpirationMonth="08", ExpirationYear="2028", Cvc ="343",
        ...
        public async Task<IActionResult> Checkout(OrderViewModel orderViewModel)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                //Ödeme işlemi başlıyor-IYZICO

                //Yapılacak ödeme isteğinin authorization seçenekleri için nesne yaratılıyor
                Options options = new Options();
                options.ApiKey = "sandbox-iQgaUjJkkLp0z3anYgaG691hTuJnRUvJ";
                options.SecretKey = "sandbox-HiNViM5Fg6Ua6sX6kFk5s91x1e2bRx2B";
                options.BaseUrl = "https://sandbox-api.iyzipay.com";

                //Yapılacak ödeme isteği nesnesi
                ...
                //Ödemenin yapılacağı kart için nesne
                ...
                {
                    //ödeme başarılıysa artık siparişi kendi veritabanımıza kaydediyoruz
