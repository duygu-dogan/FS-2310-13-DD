...
const server = http.createServer((request, response) => {
    ...
    {
        fs.readFile('./UI/products.html', (err, html) => 
        {
            response.writeHead(200, {"Content-Type":'text/html'});
            response.write(html);
            response.end();
    ...
    {
        fs.readFile('./UI/categories.html', (err, html) => 
        {
            response.writeHead(200, {"Content-Type":'text/html'});
            response.write(html);
            response.end();
       ...
       request.on('end', () => {
            ...
            fs.appendFile('products.txt', parsedData, (err)=> {
                ...
                }else
                {
                    ...
                    response.setHeader("Location", "/nodejs04/UI/products.html");
                    response.end();
                }
            });
       });
    ...
    {
        fs.readFile('./UI/create.html', (err, html) => 
        {
            response.writeHead(200, {"Content-Type":'text/html'});
            response.write(html);
            response.end();
    ...
    {
        fs.readFile('./UI/404.html', (err, html) => 
        {
            response.writeHead(200, {"Content-Type":'text/html'});
            response.write(html);
            response.end();
